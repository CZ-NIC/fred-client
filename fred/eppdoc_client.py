...
def make_sort_by_names():
    ...
    sort_by_names = {
       ...
       'contact:info': ('contact', (
         ...
         ('extension.mailingAddr.street', 1, _T('Mailing address / Street')),
         ('extension.mailingAddr.city', 1, _T('Mailing address / City')),
         ('extension.mailingAddr.sp', 1, _T('Mailing address / State or province')),
         ('extension.mailingAddr.pc', 1, _T('Mailing address / Postal code')),
         ('extension.mailingAddr.cc', 1, _T('Mailing address / Country code')),
