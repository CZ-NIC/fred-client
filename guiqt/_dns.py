...
#
# Created: Po říj 23 10:24:34 2006
...
class FredWindow(QWidget):
    ...
    def addr_current_changed(self,a0,a1):
        print "FredWindow.addr_current_changed(int,int): Not implemented yet"

    def addr_value_changed(self,a0,a1):
        print "FredWindow.addr_value_changed(int,int): Not implemented yet"
