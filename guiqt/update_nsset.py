...
#
# Created: Po říj 2 16:18:13 2006
...
class frame(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.textLabel4.setGeometry(QRect(10,470,160,20))

        self.add_status = QCheckBox(self,"add_status")
        self.add_status.setGeometry(QRect(10,600,150,20))

        self.textLabel5 = QLabel(self,"textLabel5")
        self.textLabel5.setGeometry(QRect(10,700,530,30))

        self.textLabel7 = QLabel(self,"textLabel7")
        self.textLabel7.setGeometry(QRect(10,860,160,100))
        self.textLabel7.setAlignment(QLabel.WordBreak | QLabel.AlignTop)
        ...
        self.add_tech.setNumRows(self.add_tech.numRows() + 1)
        self.add_tech.verticalHeader().setLabel(self.add_tech.numRows() - 1,self.__tr("1"))
        ...
        self.rem_tech.setNumRows(self.rem_tech.numRows() + 1)
        self.rem_tech.verticalHeader().setLabel(self.rem_tech.numRows() - 1,self.__tr("1"))
        ...
        self.rem_dns_name = QTable(self,"rem_dns_name")
        self.rem_dns_name.setNumCols(self.rem_dns_name.numCols() + 1)
        self.rem_dns_name.horizontalHeader().setLabel(self.rem_dns_name.numCols() - 1,self.__tr("dns name"))
        self.rem_dns_name.setNumRows(self.rem_dns_name.numRows() + 1)
        self.rem_dns_name.verticalHeader().setLabel(self.rem_dns_name.numRows() - 1,self.__tr("1"))
        self.rem_dns_name.setGeometry(QRect(180,740,360,110))
        self.rem_dns_name.setFrameShape(QTable.StyledPanel)
        self.rem_dns_name.setFrameShadow(QTable.Sunken)
        self.rem_dns_name.setNumRows(1)
        self.rem_dns_name.setNumCols(1)
        self.rem_dns_name.setShowGrid(1)
        self.rem_dns_name.setFocusStyle(QTable.SpreadSheet)

        self.textLabel6 = QLabel(self,"textLabel6")
        self.textLabel6.setGeometry(QRect(10,740,160,100))
        self.textLabel6.setAlignment(QLabel.WordBreak | QLabel.AlignTop)
        ...
        self.textLabel9.setGeometry(QRect(10,1180,160,20))
        ...
        self.textLabel3_2.setGeometry(QRect(10,1100,530,21))
        ...
        self.connect(self.rem_dns_name,SIGNAL("currentChanged(int,int)"),self.rem_dns_name_current_changed)
        self.connect(self.rem_dns_name,SIGNAL("valueChanged(int,int)"),self.rem_dns_name_value_changed)
        ...
        self.setTabOrder(self.add_clientTransferProhibited,self.rem_dns_name)
        self.setTabOrder(self.rem_dns_name,self.rem_tech)
    ...
    def languageChange(self):
        ...
        self.textLabel7.setText(self.__tr("technical contact"))
        self.rem_status.setText(self.__tr("status"))
        self.add_tech.horizontalHeader().setLabel(0,self.__tr("technical contact"))
        self.add_tech.verticalHeader().setLabel(0,self.__tr("1"))
        self.rem_tech.horizontalHeader().setLabel(0,self.__tr("technical contact"))
        self.rem_tech.verticalHeader().setLabel(0,self.__tr("1"))
        self.rem_dns_name.horizontalHeader().setLabel(0,self.__tr("dns name"))
        self.rem_dns_name.verticalHeader().setLabel(0,self.__tr("1"))
        self.textLabel6.setText(self.__tr("dns name<br>(max 9 names)"))
        self.textLabel9.setText(self.__tr("clTRID"))
        self.textLabel3_2.setText(self.__tr("<h3>Change</h3>"))
        self.textLabel8.setText(self.__tr("pasword"))
        self.textLabel1.setText(self.__tr("<h2>update_nsset</h2>\n"
...
"   Names what are not included into disclose list are set to opposite value of the disclose flag value."))
    ...
    def add_tech_current_changed(self,a0,a1):
        print "frame.add_tech_current_changed(int,int): Not implemented yet"

    def add_tech_value_changed(self,a0,a1):
        print "frame.add_tech_value_changed(int,int): Not implemented yet"

    def rem_dns_name_current_changed(self,a0,a1):
        print "frame.rem_dns_name_current_changed(int,int): Not implemented yet"

    def rem_dns_name_value_changed(self,a0,a1):
        print "frame.rem_dns_name_value_changed(int,int): Not implemented yet"

    def rem_tech_current_changed(self,a0,a1):
        print "frame.rem_tech_current_changed(int,int): Not implemented yet"

    def rem_tech_value_changed(self,a0,a1):
        print "frame.rem_tech_value_changed(int,int): Not implemented yet"
