...
Ticket #253 (defect)
V tuto chvili se nikde netestuje zda ma prihlaseny registrator pravo na praci v dane zone. V pripade ze nema je treba u opraci *_domain vyhodit chybovou hlasku.

1. zalozeni pomocneho kontaktu
2. zalozeni pomocneho nssetu

Ticket #113 Tento prikaz spadne. Dle me je adresa 2001:200::fea5:3015 korektni.
Ticket #119 Je mozne registrovat domenu tretiho radu create-domain www.ipex.cz
Ticket #122 www..cz
Ticket #126 create-domain -w.cz w-.cz w--w.cz
čeština.cz
.cz
nic.cx 
nicnet
...
x. smazani pomocneho nssetu
x. smazani pomocneho kontaktu
"""
import time
import unittest
import ccReg
